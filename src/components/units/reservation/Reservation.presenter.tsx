...
export default function Reservation01UI(props: any) {
  return (
    <S.Container>
      <S.Wrapper>
        <S.StepBar>
          <S.Step isActive={props.isActive}>01.날짜/매장/테마 선택</S.Step>
        ...
        <S.SearchBarBox>
          ...
          <select
            style={{ textAlign: "center", padding: "1em", marginRight: "1em" }}
          >
          ...
          <select style={{ textAlign: "center", padding: "1em" }}>
            <option disabled selected>
              테마를 선택해주세요
            </option>
        ...
        <S.ImageTimeBox>
          ...
          <S.TimeWrapper>
            <S.TwoTimeBox>
              <S.TimeButton onClick={props.onClickTime}>11시 30분</S.TimeButton>
            </S.TwoTimeBox>
          </S.TimeWrapper>
        </S.ImageTimeBox>
      </S.Wrapper>
